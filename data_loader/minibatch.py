...
class NodeMinibatchIterator(object):
    ...
    def __init__(self, G, id2idx,
        ...
        print('---all node:{}'.format(len(G.node)))
        print('---train node:{}'.format(len(self.train_nodes)))
        print('---val node:{}'.format(len(self.test_nodes)))
        print('---test node:{}'.format(len(self.val_nodes)))
